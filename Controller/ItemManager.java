...
public class ItemManager {
	...
	/*
	 * This is a recursive method that calculates the total income In a situation
	 * where all items are rented.
	 */
	...
	/*
	 * This class makes sure that each username Can only have 1 item with a unique
	 * name Returns true if it finds an existed item name for the current owner
	 * False if it did not
	 */
	...
	/*
	 * Returns items with the owner name equals to the current username
	 */
